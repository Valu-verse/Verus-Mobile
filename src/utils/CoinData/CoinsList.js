...
export const coinsList = {
  ...
  VRSCTEST: {
    ...
    website: 'https://verus.io',
    fee: 10000,
    compatible_channels: [DLIGHT_PRIVATE, VERUSID, VRPC, GENERAL],
  ...
  ["iFMqivtShssEpViJbVtqVz53rsXvjqndQn"]: {
    pbaas_options: 32,
    id: "iFMqivtShssEpViJbVtqVz53rsXvjqndQn",
    currency_id: "iFMqivtShssEpViJbVtqVz53rsXvjqndQn",
    system_id: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq",
    launch_system_id: "iJhCezBExJHvtyH3fGhNnt2NhU4Ztkf2yq",
    bitgojs_network_key: "verustest",
    display_ticker: "vUSDC",
    display_name: "vUSDC on Verus Testnet",
    alt_names: [],
    theme_color: '#29233b',
  ...
  MATIC: {
    ...
    alt_names: ['polygon', 'matic'],
    theme_color: '#8247E5',
    website: 'https://polygon.technology/',
    rate_url_params: {coin_paprika: 'matic-polygon'},
    compatible_channels: [ETH, GENERAL],
    dominant_channel: ETH,
    tags: [],
    proto: 'eth',
  ...
  MATIC_AMOY: {
    ...
    alt_names: ['polygon amoy', 'matic amoy'],
    theme_color: '#8247E5',
    website: 'https://polygon.technology/',
    compatible_channels: [ETH],
    dominant_channel: ETH,
