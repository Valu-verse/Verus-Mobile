...
export const CONNECTED_SERVICES = [VERUSID_SERVICE_ID, GIFT_CARD_SERVICE_ID, /*PBAAS_PRECONVERT_SERVICE_ID ,*/ WYRE_SERVICE_ID, VALU_SERVICE_ID, ATTESTATION_SERVICE_ID]
...
export const VALU_POL_PAYMENT_STARTED = 'VALU_POL_PAYMENT_STARTED'
export const VALU_POL_PAYMENT_PENDING = 'VALU_POL_PAYMENT_PENDING'
export const VALU_POL_PAYMENT_COMPLETE = 'VALU_POL_PAYMENT_COMPLETE'
export const VALU_POL_PAYMENT_FAILED = 'VALU_POL_PAYMENT_FAILED'
export const VALU_POL_PAYMENT_RECEIVED = 'VALU_POL_PAYMENT_RECEIVED'
export const VALU_POL_IDENTITY_CONFIRMED = 'VALU_POL_IDENTITY_CONFIRMED'
export const VALU_POL_IDENTITY_PROVISIONED_PENDING = 'VALU_POL_IDENTITY_PROVISIONED_PENDING'
export const VALU_POL_IDENTITY_PROVISIONED = 'VALU_POL_IDENTITY_PROVISIONED'
export const VALU_POL_READY = 'VALU_POL_READY'
export const VALU_POL_PENDING = 'VALU_POL_PENDING'
export const POP_RECEIVED = 'POP_RECEIVED'
