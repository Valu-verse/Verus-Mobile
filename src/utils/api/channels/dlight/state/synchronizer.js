...
export const startSync = (coinId, coinProto, accountHash) => {
  return Promise.resolve("done"); //VerusLightClient.startSync(coinId, coinProto, accountHash)
}
...
export const stopSync = (coinId, coinProto, accountHash) => {
  return Promise.resolve("done"); //VerusLightClient.stopSync(coinId, coinProto, accountHash)
}