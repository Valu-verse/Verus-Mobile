...
import * as identitykeys from 'verus-typescript-primitves/dist/vdxf/identitydatakeys';
import * as keylist from 'verus-typescript-primitves/dist/vdxf/keys';

export const IMPLEMENTED_LOCALES = ['EN'];

export const getFriendlyNameForVdxfKey = (vdxfkey, locale = 'EN') => {

  if (!IMPLEMENTED_LOCALES.includes(locale)) {
    throw new Error(locale + " is not implemented");
  }

  if (vdxfkey in IdentityVdxfidMap[locale]) {

    return IdentityVdxfidMap[vdxfkey][locale];
